        ...
        return $form
            ->schema([
                \Filament\Forms\Components\Tabs::make('Tabs')
                    ->tabs([
                        \Filament\Forms\Components\Tabs\Tab::make('Product Information')
                        ...
                        \Filament\Forms\Components\Tabs\Tab::make('Product Description')
                        ...
                        \Filament\Forms\Components\Tabs\Tab::make('Product Images & Sizes')
    ...
    public static function table(Table $table): Table
    {
        return $table
                ...
                Tables\Columns\Layout\Stack::make([
                    ...
                    Tables\Columns\Layout\Split::make([
                        ...
                        TextColumn::make('prod_quantity')
                            ->label('Quantity')
                            ->badge()
                            ->hidden(fn($record) => $record?->prod_unit === 'diff_size' || $record?->prod_quantity < 1)
            ...
            ->actions([
                ...
                TableAction::make('show_diff_sizes')
                    ->label('Show Sizes')
                    ->icon('heroicon-m-eye')
                    ->color('success')
                    ->hidden(fn($record) => $record?->prod_unit !== 'diff_size')
