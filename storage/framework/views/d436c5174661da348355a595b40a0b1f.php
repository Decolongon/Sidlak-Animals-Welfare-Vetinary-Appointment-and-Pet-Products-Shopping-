            ...
            <div class="flex flex-col items-center justify-between mb-6 lg:flex-row">
                <div class="p-6 overflow-hidden lg:p-8 ">
                    ...
                    <p class="mb-6 text-gray-800 dark:text-neutral-200">
                        <?php echo e(__('Welcome to your dashboard')); ?>
                ...
                <div class="border-b-2 border-gray-200 dark:border-neutral-700">
                    <nav class="-mb-0.5 flex gap-x-6">
                        ...
                        <a wire:navigate href="<?php echo e(route('view-order')); ?>" 
                           class="inline-flex items-center gap-2 px-1 py-4 text-sm font-medium whitespace-nowrap
                               <?php echo e(request()->routeIs('vieworder') ? 'border-b-2 text-amber-600 border-amber-500' : 'text-gray-500 border-b-2 border-transparent hover:text-amber-600'); ?>

                               focus:outline-none focus:text-amber-800 dark:<?php echo e(request()->routeIs('vieworder') ? 'text-amber-500' : 'neutral-500'); ?>">
                        ...
                        <a wire:navigate href="<?php echo e(route('page.cart')); ?>" 
                           class="inline-flex items-center gap-2 px-1 py-4 text-sm font-medium whitespace-nowrap
                               <?php echo e(request()->routeIs('page.cart') ? 'border-b-2 text-amber-600 border-amber-500' : 'text-gray-500 border-b-2 border-transparent hover:text-amber-600'); ?>

                               focus:outline-none focus:text-amber-800 dark:<?php echo e(request()->routeIs('page.cart') ? 'text-amber-500' : 'neutral-500'); ?>">
                        ...
                        <?php if(Auth::user()->hasRole('volunteer')): ?>
                            <a wire:navigate href="<?php echo e(route('page.announcements')); ?>"
                               class="inline-flex items-center gap-2 px-1 py-4 text-sm whitespace-nowrap
                                   <?php echo e(request()->routeIs('page.announcements') ? 'border-b-2 text-amber-600 border-amber-500' : 'text-gray-500 border-b-2 border-transparent hover:text-amber-600'); ?>

                                   focus:outline-none focus:text-amber-800 dark:<?php echo e(request()->routeIs('page.announcements') ? 'text-amber-500' : 'neutral-500'); ?>">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sidlak-vet-appointment-and-pet-shop\resources\views/dashboard.blade.php ENDPATH**/ ?>