    ...
    <div class="w-full mt-5 lg:mt-8">
        ...
        <div class="relative">
          ...
          <div class="absolute z-50 w-full bg-gray-100 rounded-xl shadow-[0_10px_40px_10px_rgba(0,0,0,0.05)] dark:bg-neutral-900" data-hs-combo-box-output="gh">
            ...
            <!--[if BLOCK]><![endif]--><?php if(count($dogs) > 0): ?>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $dogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="flex items-center px-3 py-2 rounded-lg gap-x-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="<?php echo e(route('page.dog.single', $dog->dog_slug)); ?>">

                    <div class="flex items-center justify-center rounded-full bg-center object-cover bg-gray-200 size-6 overflow-hidden me-2.5">
                        <img class="object-cover" src="<?php echo e(asset(Storage::url($dog->dog_image[0]['dog_image']))); ?>" alt="<?php echo e($dog->name); ?>" />
                    </div>

                    <span class="text-sm text-gray-800 dark:text-neutral-200" data-hs-combo-box-search-text="Compose an email" data-hs-combo-box-value="<?php echo e($dog->breed->dog_name); ?>"><?php echo e($dog->dog_name); ?> (<?php echo e($dog->breed->breed_name); ?>)</span>
                    <span class="text-xs text-gray-400 ms-auto dark:text-neutral-500" data-hs-combo-box-search-text="Gmail" data-hs-combo-box-value="<?php echo e($dog->status); ?>"><?php echo e($dog->status); ?></span>
                </a>
...
<?php /**PATH C:\laragon\www\sidlak-vet-appointment-and-pet-shop\resources\views/livewire/pages/dog-search.blade.php ENDPATH**/ ?>