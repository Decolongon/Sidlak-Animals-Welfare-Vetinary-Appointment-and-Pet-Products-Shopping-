                            ...
                            <?php if(Laravel\Jetstream\Jetstream::managesProfilePhotos()): ?>
                                <button
                                    ...
                                    <img class="object-cover w-8 h-8 rounded-full"
                                        src="<?php echo e(Auth::user()->profile_photo_url); ?>" alt="" />
                                </button>
                            <?php else: ?>
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-black transition duration-150 ease-in-out border border-transparent rounded-md bg-amber-400 hover:bg-amber-500 hover:text-gray-900 focus:outline-none focus:bg-amber-500 active:bg-amber-500">
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 z-10 bg-white shadow-md rounded-lg p-2 dark:bg-neutral-800 dark:border dark:border-neutral-700"
                                ...
                                <div class="py-2 mt-2 first:pt-0 last:pb-0">
                                    ...
                                    <?php if(Laravel\Jetstream\Jetstream::hasApiFeatures()): ?>
                                        <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-amber-500 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300"
                                            href="<?php echo e(route('api-tokens.index')); ?>">
