        ...
        <div class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700">
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                ...
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $adoptionRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $adoptionRequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        $currentStatus = $adoptionRequest->status;
                    ?>
                    <tr wire:key="adoptionRequest-<?php echo e($adoptionRequest->id); ?>" class="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                        <td class="align-top size-px whitespace-nowrap">
                         <span class="block p-6 text-sm text-gray-600 dark:text-neutral-400"><?php echo e($adoptionRequest->adoption_number); ?></span>
                        </td>

                        <td class="align-top size-px whitespace-nowrap">
                            <a type="button" class="block p-6" wire:key='<?php echo e($adoptionRequest->id); ?>' wire:click.prevent="viewRequest(<?php echo e($adoptionRequest->id); ?>)">
                                <div class="flex items-center gap-x-3">
                                <img class="inline-block size-[38px] rounded-full  object-cover" src="<?php echo e(asset(Storage::url($adoptionRequest->dog->dog_image[0]['dog_image']))); ?>" alt="<?php echo e($adoptionRequest->dog->dog_name); ?>">
                                <div class="grow">
                                    <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200"><?php echo e($adoptionRequest->dog->dog_name); ?></span>
                                    <span class="block text-sm text-gray-500 dark:text-neutral-500"><?php echo e($adoptionRequest->dog->breed->breed_name); ?></span>
                                </div>
                                </div>
                            </a>
                        </td>
                        ...
                        <a class="block p-6" href="#">
                            <span class="text-sm text-gray-600 dark:text-neutral-400"><?php echo e($adoptionRequest->created_at->diffForHumans()); ?></span>
                        </a>
                        </td>

                        <td class="align-top size-px whitespace-nowrap">
                            <a class="block p-6" href="#">
                                <span class="py-2 px-2.5 inline-flex items-center gap-x-1 text-xs font-medium <?php echo e($statusConfig[$currentStatus]['bg_class']); ?>">
                                    <?php echo $statusConfig[$currentStatus]['icon']; ?>

                                    <?php echo e(Str::upper($currentStatus)); ?>
                        ...
                        <td class="size-px whitespace-nowrap">
                            <div class="flex flex-row items-center justify-content-between">
                                ...
                                <button wire:key='<?php echo e($adoptionRequest->id); ?>' wire:click.prevent="viewRequest(<?php echo e($adoptionRequest->id); ?>)"  type="button" class="block" >
                                  ...
                                  <button wire:click.prevent="removeAdoptionRequest(<?php echo e($adoptionRequest->id); ?>)" type="submit" class="text-red-500 hover:text-red-700">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'view-modal','maxWidth' => 'xxl','wire:model' => 'isModalOpen']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'view-modal','maxWidth' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('xxl'),'wire:model' => 'isModalOpen']); ?>
        <div class="w-full mx-auto text-center lg:mb-10">
            <h4 class="text-xl font-bold text-gray-800 dark:text-white"><?php echo e('Adoption Request'); ?></h4>
            <p class="text-sm text-gray-600 dark:text-gray-200">Detailed information about the adoption request</p>
        </div>

        <!--[if BLOCK]><![endif]--><?php if($viewAdoptionRequest): ?>
            <!-- Grid -->
            <div class="grid gap-5 md:grid-cols-3">

                <div>
                    <!--[if BLOCK]><![endif]--><?php if($viewAdoptionRequest->dog): ?>
                        <img class="inline-block w-auto h-[15rem] rounded-lg object-cover"
                             src="<?php echo e(asset(Storage::url($viewAdoptionRequest->dog->dog_image[0]['dog_image'] ?? 'default.jpg'))); ?>"
                             alt="<?php echo e($viewAdoptionRequest->dog->dog_name ?? 'No name available'); ?>">
                    <?php else: ?>
                ...
                <div class="lg:col-span-2">
                    <div class="grid space-y-3">
                        ...
                        <dl class="flex flex-col text-sm sm:flex-row gap-x-3">
                            ...
                            <dd class="font-medium text-gray-800 dark:text-neutral-200">
                                <span class="block font-semibold">
                                    <?php echo e($viewAdoptionRequest->adoption_number ?? 'No adoption number'); ?>
                        ...
                        <dl class="flex flex-col text-sm sm:flex-row gap-x-3">
                            ...
                            <dd class="text-gray-800 dark:text-neutral-200">
                                ...
                                <span class="inline-flex items-center px-4 py-2 text-green-800 bg-green-100 rounded-full gap-x-1 text-md font-lg dark:bg-green-500/10 dark:text-green-500">
                                    ...
                                    <?php echo e($viewAdoptionRequest->dog->dog_name ?? 'No name available'); ?>
                        ...
                        <dl class="flex flex-col text-sm sm:flex-row gap-x-3">
                            ...
                            <dd class="font-medium text-gray-800 dark:text-neutral-200">
                                <span class="block font-normal">
                                    <?php echo e($viewAdoptionRequest->dog->breed->breed_name ?? 'No breed'); ?>

                                </span>
                                <address class="text-xs not-italic text-gray-500 font-xs dark:text-neutral-500">
                                    <?php echo e(Str::ucfirst($viewAdoptionRequest->dog->dog_size) ?? 'No address available'); ?>
                        ...
                        <dl class="flex flex-col text-sm sm:flex-row gap-x-3">
                            ...
                            <dd class="font-medium text-gray-800 dark:text-neutral-200">
                                <span class="block font-semibold">
                                    <?php echo e($viewAdoptionRequest->dog->dog_age ?? 'No age'); ?>
                        ...
                        <dl class="flex flex-col text-sm sm:flex-row gap-x-3">
                            ...
                            <dd class="font-medium text-gray-800 dark:text-neutral-200">
                                <span class="block font-semibold">
                                    <?php echo e(Str::upper($viewAdoptionRequest->status) ?? 'No status'); ?>
...
<?php /**PATH C:\laragon\www\sidlak-vet-appointment-and-pet-shop\resources\views/livewire/pages/adoption-requests.blade.php ENDPATH**/ ?>