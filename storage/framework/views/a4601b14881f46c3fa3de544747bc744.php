<div id="hs-offcanvas-custom-backdrop-color"
    class="hs-overlay hs-overlay-open:translate-x-0 hs-overlay-backdrop-open:bg-black/50 dark:hs-overlay-backdrop-open:bg-black/30 hidden translate-x-full fixed top-0 end-0 transition-all duration-300 transform h-full max-w-xs w-full z-[80] bg-white border-s dark:bg-neutral-800 dark:border-neutral-700"
    role="dialog" tabindex="-1" aria-labelledby="hs-offcanvas-custom-backdrop-color-label" wire:ignore.self>
        ...
        <div class="flex flex-col gap-4 max-h-[70vh] overflow-y-auto pr-2 pb-28">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $this->getCarts(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="p-4 border rounded-lg shadow dark:border-neutral-700 dark:shadow-gray-900"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <input type="checkbox"
                                ...
                                name="selectedItems" wire:model="selectedItems" value="<?php echo e($cart->id); ?>">
                            ...
                            <div wire:ignore
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(isset($cart->variant)): ?>
                                    <img src="<?php echo e(asset(Storage::url($cart->variant->url))); ?>"
                                        alt="<?php echo e($cart->product->prod_slug); ?>" class="object-cover w-full h-full">
                                <?php else: ?>
                                    <!--[if BLOCK]><![endif]--><?php if($cart->product->primary_image && $cart->product->primary_image->url): ?>
                                        <img src="<?php echo e(asset(Storage::url($cart->product->primary_image->url))); ?>"
                                            alt="<?php echo e($cart->product->prod_slug); ?>" class="object-cover w-full h-full">
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                            <div>
                                <div class="font-medium text-gray-800 dark:text-neutral-200" wire:ignore>
                                    <?php echo e(ucwords($cart->product->prod_name)); ?>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($cart->product->prod_unit === 'kg' || $cart->product->prod_unit === 'g'): ?>
                                        <span class="text-sm text-gray-600 dark:text-neutral-400 whitespace-nowrap">
                                            <?php echo e(number_format($cart->product->prod_weight, 2)); ?>

                                            <?php echo e($cart->product->prod_unit); ?>
                                ...
                                <div class="text-sm text-gray-600 dark:text-neutral-400">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($cart->product->discounted_price !== null && $cart->product->prod_unit !== 'diff_size'): ?>
                                        ...
                                        <small
                                            class="text-success d-block"><?php echo e($cart->product->discount_label); ?></small>
                                    <?php else: ?>
                                        <!--[if BLOCK]><![endif]--><?php if(isset($cart->variant)): ?>
                                            ₱<?php echo e(number_format($cart->quantity * $cart->variant->price, 2)); ?>
                    ...
                    <div x-data="{ loading: false }" x-on:livewire:start.decreaseQuantity="loading = true"
                        ...
                        <button type="button" wire:click="decreaseQuantity('<?php echo e($cart->id); ?>')"
                            x-bind:disabled="loading" wire:loading.attr="disabled"
                        ...
                        <button type="button" wire:click="increaseQuantity('<?php echo e($cart->id); ?>')"
                            x-bind:disabled="loading" wire:loading.attr="disabled"
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="text-center py-10 text-gray-500 dark:text-neutral-400 text-lg whitespace-nowrap">
                    Cart is Empty.
