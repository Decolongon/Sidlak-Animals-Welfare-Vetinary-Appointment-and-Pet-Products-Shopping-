          ...
          <div class="hs-carousel-slide w-full flex-shrink-0">
            <div class="relative w-full h-full flex flex-col">
              ...
              <div class="relative mt-auto w-full sm:w-2/3 md:max-w-lg ps-5 pb-5 md:ps-10 md:pb-10">
                ...
                <div class="mt-5">
                  <a  class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-xl bg-amber-400 hover:bg-amber-500 text-black border border-transparent focus:outline-hidden disabled:opacity-50 disabled:pointer-events-none" href="{{ route('page.shop') }}">
    ...
    <div class="mb-24 md:mb-0 sm:px-6">
      <div class="relative">
        ...
        <div class="absolute bottom-0 start-0 -z-1 translate-y-10 -translate-x-14">
          {{-- <svg class="max-w-40 h-auto text-gray-400 dark:text-neutral-700" width="696" height="653" viewBox="0 0 696 653" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <footer class="mt-6">
          <div class="flex items-center">
            ...
            <div class="ms-4 md:ms-0">
              <div class="text-base font-semibold text-gray-800 dark:text-neutral-200">Nicole Grazioso</div>
              <div class="text-xs text-gray-500 dark:text-neutral-400">Director Payments & Risk | Airbnb</div>
            </div>
          </div>
        </footer>
