<div> {{-- open. --}}
    ...
    @if ($isBuyNowMode)
        <div class="ml-3">
            <h3 class="text-sm font-semibold text-blue-800">Buy Now Mode</h3>
    ...
    <div class="p-8 mx-auto my-12 max-w-7xl">
        <div class="grid grid-cols-2 mx-auto gap-x-8">
            <div>
                ...
                <div
                    class="flex flex-col mb-6 bg-white border shadow-sm lg:mb-10 rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
                                    ...
                                    <div class="inline-block min-w-full align-middle sm:px-6 lg:px-8">
                                        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                            <thead class="bg-gray-50 dark:bg-neutral-800">
                                                <tr>
                                                    <th scope="col"
                                                        class="px-3 py-3 text-left text-sm font-medium text-gray-500 dark:text-neutral-400 uppercase">
                                                        Product</th>
                                                    <th scope="col"
                                                        class="px-3 py-3 text-right text-sm font-medium text-gray-500 dark:text-neutral-400 uppercase">
                                                        Price</th>
                                                    <th scope="col"
                                                        class="px-3 py-3 text-right text-sm font-medium text-gray-500 dark:text-neutral-400 uppercase">
                                                        Quantity</th>
                                            ...
                                            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                                @foreach ($checkoutItems as $item)
                                                    <tr wire:key="item-{{ $item->id }}">
                                                        <td
                                                            class="px-3 py-4 text-sm text-gray-800 dark:text-neutral-200">
                                                            <div class="flex items-center">
                                                                <div wire:ignore
                                                                    class="w-16 h-16 flex-shrink-0 overflow-hidden rounded-md border border-gray-200 dark:border-neutral-700">
                                                                ...
                                                                <div class="ml-4" wire:ignore>
                                                                    <h3
                                                                        class="font-medium text-gray-900 dark:text-neutral-200">
                                                                        {{ $item->product->prod_name }}
                                                                        @if (isset($item->variant))
                                                                            - {{ ucwords($item->variant->sizes) }}
                                                                        @endif
            ...
            <div>
                ...
                <form wire:key="checkout-form-{{ auth()->id() }}" wire:submit="placeOrder">
                    ...
                    <div>
                        <h3 class="text-xl mt-3 font-semibold text-gray-700 dark:text-neutral-400">Shipping Address
                        </h3>
                        <div class="space-y-3">
                    ...
                    <div>
                        <h3 class="text-lg mt-2 mb-2 font-semibold text-gray-700 dark:text-neutral-400">Payment
                            Method
                        </h3>
                        <div x-data="{ paymentMethod: @entangle('payment_method') }">
                            ...
                            <div class="grid sm:grid-cols-2 gap-2">
                                <!-- Cash on Delivery -->
                                <label
                                    class="flex p-3 w-full bg-white border border-gray-200 rounded-lg text-sm dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                                    <input type="radio" id="payment-cod" name="shipping_method"
                                        wire:model="shipping_method" value="COD"
                                    ...
                                    <span class="text-sm text-gray-500 ms-3 dark:text-neutral-400">Cash on
                                        Delivery</span>
                                </label>

                                <label
                                    class="flex p-3 w-full bg-white border border-gray-200 rounded-lg text-sm dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                                    <input type="radio" name ="shipping_method" id="payment-ewallet"
                                        wire:model="shipping_method" value="e-wallet"
                                        class="shrink-0 mt-0.5 border-gray-200 rounded-sm text-blue-600 dark:bg-neutral-800 dark:border-neutral-700"
                                ...
                                <div class="grid gap-4 sm:grid-cols-2">
                                    <div class="relative flex items-start">
                                        <div class="flex items-center h-5 mt-1">
                                            <input id="payment-gcash" name="payment_method" type="radio"
                                                value="gcash" wire:model.live="shipping_method"
                                        ...
                                        <span
                                            class="text-sm items-center ml-2 mt-1 text-black-500 dark:text-neutral-400">GCash</span>
                                    </div>

                                    <div class="relative flex items-start">
                                        <div class="flex items-center h-5 mt-1">
                                            <input id="payment-card" name="payment_method" type="radio"
                                                value="card" wire:model.live="shipping_method"
                                                class="border-gray-200 rounded-full text-amber-600"
                                                :disabled="paymentMethod !== 'ewallet'">
                                        </div>
                                        ...
                                        <span
                                            class="text-sm items-center ml-2 mt-1 text-black-500 dark:text-neutral-400">Visa/Mastercard</span>
                                    </div>

                                    <div class="relative flex items-start">
                                        <div class="flex items-center h-5 mt-1">
                                            <input id="payment-paymaya" name="payment_method" type="radio"
                                                value="paymaya" wire:model.live="shipping_method"
                                                class="border-gray-200 rounded-full text-amber-600"
                                                :disabled="paymentMethod !== 'ewallet'">
                                        </div>
                                        ...
                                        <span
                                            class="text-sm items-center ml-2 mt-1 text-black-500 dark:text-neutral-400">Paymaya</span>
                                    </div>

                                    <div class="relative flex items-start">
                                        <div class="flex items-center h-5 mt-1">
                                            <input id="payment-grabpay" name="payment_method" type="radio"
                                                value="grab_pay" wire:model.live="shipping_method"
                                                class="border-gray-200 rounded-full text-amber-600"
                                                :disabled="paymentMethod !== 'ewallet'">
                                        </div>
                                        ...
                                        <span
                                            class="text-sm items-center ml-2 mt-1 text-black-500 dark:text-neutral-400">GrabPay</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @if ($shipping_method === 'card')
                        <div
                            class="p-4 mb-4 bg-white border border-gray-200 shadow-sm lg:mb-5 rounded-xl md:p-5 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                            <h3
                                class="font-medium inline-block text-sm text-gray-800 mt-2.5 mb-3 dark:text-neutral-200">
                                {{ 'Card Details' }}</h3>
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div>
                                    <span
                                        class="block mb-2 text-sm text-gray-600 dark:text-neutral-500">{{ 'Expiration Month' }}</span>
                                ...
                                <div>
                                    <span class="block mb-2 text-sm text-gray-600 dark:text-neutral-500">
                                        {{ 'Year' }}</span>
                    ...
                    <div class="gap-6 mt-6 mb-2">
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Product
                                Subtotal:</span>
                            <span
                                class="text-sm text-gray-700 dark:text-neutral-300">₱{{ number_format($itemsTotal, 2) }}</span>
                        </div>

                        {{-- Shipping --}}
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Shipping
                                Subtotal:</span>
                        ...
                        {{-- Total --}}
                        <div
                            class="flex items-center justify-between mt-4 pt-2 border-t border-gray-200 dark:border-neutral-700">
                            <span class="text-md font-semibold text-gray-800 dark:text-neutral-200">Total:</span>
                            <span
                                class="text-md font-semibold text-gray-800 dark:text-neutral-200">₱{{ number_format($subtotal, 2) }}</span>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end mt-6 mb-2">
                        <x-button type="submit" wire:target="placeOrder" class="w-full sm:w-auto"
                            wire:loading.attr="disabled">
                        ...
                        <button wire:click.prevent="cancelOrder">Cancel Order</button>
                    </div>
            </div>
            </form>
        </div>
