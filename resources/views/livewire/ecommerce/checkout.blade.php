        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div class="order-2 lg:order-1">
                <div class="sticky top-4">
                    ...
                    <a wire:navigate.hover href="{{ route('page.shop') }}"
                    ...
                    <div class="bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70 overflow-hidden mt-4">
                        <div class="p-4 md:p-6">
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                    <thead class="bg-gray-50 dark:bg-neutral-800">
                                        <tr>
                                            <th scope="col" class="px-3 py-3 text-left text-xs md:text-sm font-medium text-gray-500 dark:text-neutral-400 uppercase">Product</th>
                                            <th scope="col" class="px-3 py-3 text-right text-xs md:text-sm font-medium text-gray-500 dark:text-neutral-400 uppercase">Price</th>
                                            <th scope="col" class="px-3 py-3 text-right text-xs md:text-sm font-medium text-gray-500 dark:text-neutral-400 uppercase">Qty</th>
                                            <th scope="col" class="px-3 py-3 text-right text-xs md:text-sm font-medium text-gray-500 dark:text-neutral-400 uppercase">Total</th>
                                        </tr>
                                    </thead>
                                            ...
                                            <tr wire:key="item-{{ $item->id }}">
                                                <td class="px-3 py-4 text-sm text-gray-800 dark:text-neutral-200">
                                                    <div class="flex items-center">
                                                        <div wire:ignore class="w-12 h-12 md:w-16 md:h-16 flex-shrink-0 overflow-hidden rounded-md border border-gray-200 dark:border-neutral-700">
                                                            @if (isset($item->variant))
                                                                <img src="{{ Storage::url($item->variant->url) }}" alt="{{ $item->product->prod_name }}" class="w-full h-full object-cover">
                                                            @else
                                                                @if ($item->product->primary_image && $item->product->primary_image->url)
                                                                    <img src="{{ Storage::url($item->product->primary_image->url) }}" alt="{{ $item->product->prod_name }}" class="w-full h-full object-cover">
                                                                @endif
                                                            @endif
                                                        </div>
                                                        <div class="ml-3">
                                                            <h3 class="text-sm md:text-base font-medium text-gray-900 dark:text-neutral-200 line-clamp-2" wire:ignore>
                                                                ...
                                                                @if ($item->product->prod_unit === 'kg' || $item->product->prod_unit === 'g')
                                                                    - {{ $item->product->prod_weight }} {{ $item->product->prod_unit }}
                                                                @endif
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="px-3 py-4 text-sm text-gray-800 dark:text-neutral-200 text-right whitespace-nowrap">
                                                ...
                                                <td class="px-3 py-4 text-sm text-gray-800 dark:text-neutral-200 text-right">
                                                    <div class="flex items-center justify-end space-x-1 md:space-x-2">
                                                        <button type="button" wire:click="decreaseQuantity({{ $item->id }})" wire:loading.attr="disabled" class="px-2 py-1 text-xs md:text-sm font-semibold rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-100 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-700">-</button>
                                                        <p class="text-center w-4 md:w-6 text-sm">{{ number_format($item->quantity, 0) }}</p>
                                                        <button type="button" wire:click="increaseQuantity({{ $item->id }})" wire:loading.attr="disabled" class="px-2 py-1 text-xs md:text-sm font-semibold rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-100 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-700">+</button>
                                                    </div>
                                                </td>
                                                <td class="px-3 py-4 text-sm text-gray-800 dark:text-neutral-200 text-right whitespace-nowrap">
                            ...
                            {{-- Payment Summary --}}
                            <div class="bg-white dark:bg-neutral-900 p-4 rounded-lg border border-gray-200 dark:border-neutral-700 mt-6">
                                ...
                                <div class="space-y-2">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-sm text-gray-800 dark:text-neutral-200">₱{{ number_format($itemsTotal, 2) }}</span>
                                    </div>

                                    <div class="flex justify-between">
                                        <span class="text-sm text-gray-600 dark:text-neutral-400">Shipping:</span>
                                        <span class="text-sm {{ $totalShipping > 0 ? 'text-gray-800 dark:text-neutral-200' : 'text-green-500' }}">
                                    ...
                                    <div class="border-t border-gray-200 dark:border-neutral-700 pt-2 mt-2">
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-semibold text-gray-800 dark:text-neutral-200">₱{{ number_format($subtotal, 2) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="sticky top-4 space-y-8">
                        ...
                        <form  wire:submit="placeOrder" class="space-y-6">
                                    ...
                                    <div class="max-h-60 overflow-y-auto py-1">
                                        @forelse ($this->cities as $city)
                                            <div class="px-4 py-3 hover:bg-gray-50 dark:hover:bg-neutral-700 cursor-pointer border-b border-gray-100 dark:border-neutral-600 last:border-b-0 transition-colors"
                                                ...
                                                <div class="text-gray-900 dark:text-neutral-200 font-medium">{{ $city->name }}</div>
                                            </div>
                                        @empty
                            ...
                            @if ($selectedCity)
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div @click="open = !open"
                                        class="w-full px-4 py-3 border border-gray-300 dark:border-neutral-600 rounded-xl bg-white dark:bg-neutral-800 text-gray-900 dark:text-neutral-200 cursor-pointer flex justify-between items-center hover:border-gray-400 dark:hover:border-neutral-500 transition-colors">
                                        <span class="{{ !$selectedBarangay ? 'text-gray-500 dark:text-neutral-400' : '' }}">
                                        ...
                                        <div class="max-h-60 overflow-y-auto py-1">
                                            @forelse ($this->barangays as $brgy)
                                                <div class="px-4 py-3 hover:bg-gray-50 dark:hover:bg-neutral-700 cursor-pointer border-b border-gray-100 dark:border-neutral-600 last:border-b-0 transition-colors"
                                                    ...
                                                    <div class="text-gray-900 dark:text-neutral-200 font-medium">{{ $brgy->name }}</div>
                                                </div>
                                            @empty
                                                <div class="px-4 py-3 text-gray-500 dark:text-neutral-400 text-center">
                                                    No barangays found
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="relative" x-data="{ open: false }">
                                            ...
                                            <div @click="open = !open"
                                                ...
                                                <span class="{{ !$billing_city ? 'text-gray-500 dark:text-neutral-400' : '' }}">
                                        ...
                                        @if ($billing_city)
                                            <div class="relative" x-data="{ open: false }">
                                                ...
                                                <div @click="open = !open"
                                                    class="w-full px-4 py-3 border border-orange-300 dark:border-orange-600 rounded-xl bg-white dark:bg-neutral-800 text-gray-900 dark:text-neutral-200 cursor-pointer flex justify-between items-center hover:border-orange-400 dark:hover:border-orange-500 transition-colors">
                                                    <span class="{{ !$billing_brgy ? 'text-gray-500 dark:text-neutral-400' : '' }}">
                    ...
                    <div class="bg-white dark:bg-neutral-900 rounded-2xl border border-gray-200 dark:border-neutral-700 shadow-sm p-6">
                            ...
                            <div class="mt-4 space-y-3" x-show="paymentMethod === 'ewallet'" x-cloak>
                                <div class="grid grid-cols-2 gap-3">
                                    @foreach ([['id' => 'payment-gcash', 'value' => 'gcash', 'img' => 'imgs/gcash.png', 'label' => 'GCash'], ['id' => 'payment-card', 'value' => 'card', 'img' => 'imgs/card.png', 'label' => 'Visa/Mastercard'], ['id' => 'payment-paymaya', 'value' => 'paymaya', 'img' => 'imgs/paymaya.png', 'label' => 'Paymaya'], ['id' => 'payment-grabpay', 'value' => 'grab_pay', 'img' => 'imgs/grabpay.png', 'label' => 'GrabPay']] as $payment)
                                        <div class="relative flex items-center p-2 border rounded-lg bg-white dark:bg-neutral-800 dark:border-neutral-700">
                                            ...
                                            <label for="{{ $payment['id'] }}"
                                                ...
                                                <span class="text-xs text-gray-700 dark:text-neutral-300">{{ $payment['label'] }}</span>
                                            </label>
                                        </div>
                                    @endforeach
                                </div>
                        ...
                        @if ($shipping_method === 'card')
                            <div class="p-4 bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 mt-4">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="grid grid-cols-3 gap-3">
                                        <div>
                                            <span class="block mb-1 text-xs text-gray-600 dark:text-neutral-500">Exp Month</span>
                                        ...
                                        <div>
                                            <span class="block mb-1 text-xs text-gray-600 dark:text-neutral-500">Year</span>
                                        ...
                                        <div>
                                            <span class="block mb-1 text-xs text-gray-600 dark:text-neutral-500">CVV</span>
